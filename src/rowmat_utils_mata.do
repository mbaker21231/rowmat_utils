...
real matrix rm_vecvecmult(real matrix A, real matrix B)
{
    return(rowsum(A :* B))
}
...
real matrix rm_matvecmult(real matrix A, real matrix B)
{
    ...
    for (i = 1; i <= cols(A); i = i + dim) {
        C = C, rm_vecvecmult(A[, i::i+dim-1], B)
    }
...
/* -------------------------------------------------------------------------- */
/* Initial scaling for Newton inversion                                       */
/* -------------------------------------------------------------------------- */

real matrix rm_alpha0(real matrix A)
{
    return(1 :/ (rowmax(rm_absrowsums(A)) :* rowmax(rm_abscolsums(A))))
}
